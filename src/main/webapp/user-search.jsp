<%-- 
    ...
    Created on : 27 may. 2022, 17:45:29
    Author     : LENOVO
--%>
        ...
        <section class="full-box page-content">
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					<li>
						<a href="user-new.jsp"><i class="fas fa-plus fa-fw"></i> &nbsp; NUEVO TECNICO</a>
					</li>
					<li>
						<a href="user-list.jsp"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE TECNICOS</a>
					</li>
					<li>
						<a class="active" href="user-search.jsp"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR TECNICO</a>
					</li>
				</ul>	
			</div>
						...
						<div class="row justify-content-md-center">
							<div class="col-12 col-md-6">
								<div class="form-group">
									<label for="inputSearch" class="bmd-label-floating">¿Qué técnico estas buscando?</label>
