                ...
                <div class="row">
                  ...
                  <div class="col-12 col-md-4">
                    <div class="form-group">
                      ...
                      <input type="text"  class="form-control" name="trabajador_nombre" id="trabajador_nombre" maxlength="50" required="required">
                    </div>
                  </div>
                  ...
                  <div class="col-12 col-md-4">
                    <div class="form-group">
                      ...
                      <input type="text"  class="form-control" name="trabajador_apepat" id="trabajador_apepat" maxlength="50" required="required">
                    </div>
                  </div>
                  <div class="col-12 col-md-4">
                    <div class="form-group">
                      <label for="trabajador_apemat" class="bmd-label-floating">Apellido materno</label>
                      <input type="text"  class="form-control" name="trabajador_apemat" id="trabajador_apemat" maxlength="50" required="required">
                    </div>
                  </div>
                  ...
                  <div class="col-12 col-md-6">
                    <div class="form-group">
                      ...
                      <input type="email" pattern ="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" class="form-control" name="trabajador_correo1" id="trabajador_correo1" maxlength="100" required="required">
                    </div>
                  </div>
