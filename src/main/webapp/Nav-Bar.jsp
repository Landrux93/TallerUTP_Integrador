...
<html>
  ...
  <body>
    <% String id = (String) request.getAttribute("id");
      ...
      String Home = "<li> <a href=\"home.jsp\"><i class=\"fab fa-dashcube fa-fw\"></i> &nbsp; Dashboard</a> </li>";
      String Cliente = "<li>"
      ...
      String Servicio = "<li>"
              ...
              + "<ul>"
              + " <li>"
              + " <a href=\"hojaservicionew.jsp\"><i class=\"fas fa-plus fa-fw\"></i> &nbsp; HOJA DE SERVICIO</a>"
              + " </li>"
              + " <li>"
              + " <a href=\"equiponew.jsp\"><i class=\"fas fa-plus fa-fw\"></i> &nbsp; Equipo</a>"
              + "</li>"
              + " </ul>"
              + " </li>";
      switch (privilegio) {
