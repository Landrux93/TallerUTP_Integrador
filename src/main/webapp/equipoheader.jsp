<%-- 
    ...
    Created on : Jun 4, 2022, 5:02:49 AM
    Author     : landrux
--%>
  ...
  <body>
            ...
            <div class="container-fluid">
                <ul class="full-box list-unstyled page-nav-tabs">
                    <li>
                        <a href="equiponew.jsp"><i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR EQUIPO</a>
                    </li>
                    <li>
                        <a href="equipo.jsp"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA EQUIPOS</a>
                    </li>
