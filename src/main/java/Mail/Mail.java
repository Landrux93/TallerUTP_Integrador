	...
	public static String sendMain(String to, String subject, String body) {
		...
		Session session = Session.getDefaultInstance(properties, new Authenticator() {
		    ...
		    protected PasswordAuthentication getPasswordAuthentication() {
		         return new PasswordAuthentication ("u20221875@utp.edu.pe", "JPMS.1995dic"); // Contraseña de la cuenta
		    }
		});
...
//		    Transport.send(message);
 // System.out.println ("¡Enviado con éxito!");
			 ...
			 // 1. Crea un cuerpo de mensaje compuesto
			Multipart multipart = new MimeMultipart();
			 // 2. Agregar archivo adjunto
			...
			//multipart.addBodyPart(filePart);
			 // 3. Agrega contenido de texto
			MimeBodyPart textPart = new MimeBodyPart();
			 textPart.setText ("¡Correo de prueba que contiene texto y archivos adjuntos!");
			multipart.addBodyPart(textPart);
			 // 4. Vincular el objeto de mensaje
